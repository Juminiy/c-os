...
void cmp_int_test_case1() {
    ...
    printf("%d\n",_int_cmp(&(arr[1]),&(arr[2]))); // expected at 0
    printf("%d\n",_int_cmp(&(arr[2]),&(arr[1]))); // expected at 1 
}
...
void swp_int_test_case1() { 
    ...
    _void_swp(&(arr[1]),&(arr[2]),sizeof(int)) ;
    printf("addr : arr[1] %p arr[2] = %p\n",&(arr[1]),&(arr[2])) ;
...
void swp_int_test_case2() {
    ...
    // expected at 
    printf("value 1 = %d , value 2 = %d\n",arr[3],arr[5]); 
    _void_swp(&(arr[3]),&(arr[5]),sizeof(int)) ;
    // expected at 
    printf("value 1 = %d , value 2 = %d\n",arr[3],arr[5]); 
